...
CalculationResult _calculation_getprocaddress_internal(const char * pProcName, void ** ppProcAddress)
{
	...
	if (!sbProcAddressMapHasBeenInitialized) {
		sProcAddressMap["calculation_calculator_enlistvariable"] = &calculation_calculator_enlistvariable;
		sProcAddressMap["calculation_calculator_getenlistedvariable"] = &calculation_calculator_getenlistedvariable;
		sProcAddressMap["calculation_calculator_clearvariables"] = &calculation_calculator_clearvariables;
		sProcAddressMap["calculation_calculator_multiply"] = &calculation_calculator_multiply;
		sProcAddressMap["calculation_calculator_add"] = &calculation_calculator_add;
		sProcAddressMap["calculation_createcalculator"] = &calculation_createcalculator;
		sProcAddressMap["calculation_getversion"] = &calculation_getversion;
		sProcAddressMap["calculation_getlasterror"] = &calculation_getlasterror;
		sProcAddressMap["calculation_releaseinstance"] = &calculation_releaseinstance;
		sProcAddressMap["calculation_acquireinstance"] = &calculation_acquireinstance;
		sProcAddressMap["calculation_injectcomponent"] = &calculation_injectcomponent;
		sProcAddressMap["calculation_getsymbollookupmethod"] = &calculation_getsymbollookupmethod;

...
**************************************************************************************************************************/
CalculationResult calculation_base_classtypeid(Calculation_Base pBase, Calculation_uint64 * pClassTypeId)
{
...
{
	IBase* pIBaseClass = (IBase *)pCalculator.Handle;
...
CalculationResult calculation_calculator_getenlistedvariable(Calculation_Calculator pCalculator, Calculation_uint32 nIndex, Numbers_Variable * pVariable)
{
	...
	try {
		...
		*pVariable = pNumbersVariable->handle();
		return CALCULATION_SUCCESS;
	}
	catch (ECalculationInterfaceException & Exception) {
		return handleCalculationException(pIBaseClass, Exception);
...
CalculationResult calculation_calculator_multiply(Calculation_Calculator pCalculator, Numbers_Variable * pInstance)
{
	...
	try {
		...
		*pInstance = pNumbersInstance->handle();
		return CALCULATION_SUCCESS;
	}
	catch (ECalculationInterfaceException & Exception) {
		return handleCalculationException(pIBaseClass, Exception);
...
CalculationResult Calculation::Impl::Calculation_GetProcAddress (const char * pProcName, void ** ppProcAddress)
{
	...
	*ppProcAddress = nullptr;
	...
	if (sProcName == "calculation_base_classtypeid") 
		*ppProcAddress = (void*) &calculation_base_classtypeid;
	if (sProcName == "calculation_calculator_enlistvariable") 
		*ppProcAddress = (void*) &calculation_calculator_enlistvariable;
	if (sProcName == "calculation_calculator_getenlistedvariable") 
		*ppProcAddress = (void*) &calculation_calculator_getenlistedvariable;
	if (sProcName == "calculation_calculator_clearvariables") 
		*ppProcAddress = (void*) &calculation_calculator_clearvariables;
	if (sProcName == "calculation_calculator_multiply") 
		*ppProcAddress = (void*) &calculation_calculator_multiply;
	if (sProcName == "calculation_calculator_add") 
		*ppProcAddress = (void*) &calculation_calculator_add;
	if (sProcName == "calculation_createcalculator") 
		*ppProcAddress = (void*) &calculation_createcalculator;
	if (sProcName == "calculation_getversion") 
		*ppProcAddress = (void*) &calculation_getversion;
	if (sProcName == "calculation_getlasterror") 
		*ppProcAddress = (void*) &calculation_getlasterror;
	if (sProcName == "calculation_releaseinstance") 
		*ppProcAddress = (void*) &calculation_releaseinstance;
	if (sProcName == "calculation_acquireinstance") 
		*ppProcAddress = (void*) &calculation_acquireinstance;
	if (sProcName == "calculation_injectcomponent") 
		*ppProcAddress = (void*) &calculation_injectcomponent;
	if (sProcName == "calculation_getsymbollookupmethod") 
		*ppProcAddress = (void*) &calculation_getsymbollookupmethod;
...
CalculationResult calculation_getsymbollookupmethod(Calculation_pvoid * pSymbolLookupMethod)
{
	...
	try {
		if (pSymbolLookupMethod == nullptr)
			throw ECalculationInterfaceException (CALCULATION_ERROR_INVALIDPARAM);
		*pSymbolLookupMethod = (void*)&Calculation::Impl::Calculation_GetProcAddress;
		return CALCULATION_SUCCESS;
	}
	catch (ECalculationInterfaceException & Exception) {
		return handleCalculationException(pIBaseClass, Exception);

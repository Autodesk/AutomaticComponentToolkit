...
# Injected Components
	...
	def _loadFunctionTable(self):
		try:
			...
			self.lib.calculation_base_classtypeid.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint64)]
	...
	def _polymorphicFactory(self, handle):
		...
		self.checkError(None, self.lib.calculation_base_classtypeid(handle, pClassTypeId))

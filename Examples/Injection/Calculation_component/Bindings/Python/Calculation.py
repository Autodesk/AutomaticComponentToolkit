...
# Injected Components
	...
	def GetLastError(self, InstanceObject):
		...
		self.checkError(None, self.lib.calculation_getlasterror(InstanceInstanceHandle, nErrorMessageBufferSize, nErrorMessageNeededChars, pErrorMessageBuffer, pHasError))

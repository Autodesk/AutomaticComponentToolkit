...
*/
typedef CalculationResult (*PCalculationBase_ClassTypeIdPtr) (Calculation_Base pBase, Calculation_uint64 * pClassTypeId);
...
typedef struct {
	...
	PCalculationBase_ClassTypeIdPtr m_Base_ClassTypeId;

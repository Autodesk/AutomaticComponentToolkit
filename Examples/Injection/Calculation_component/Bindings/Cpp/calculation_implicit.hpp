...
std::shared_ptr<T> CWrapper::polymorphicFactory(CalculationHandle pHandle)
{
	...
	*/
	...
	{
		CalculationHandle hInstance = CalculationHandleNull;
	...
	*/
	Calculation_uint64 CBase::ClassTypeId()
	{
		...
		CheckError(calculation_base_classtypeid(m_pHandle, &resultClassTypeId));
	...
	*/
	...
	{
		NumbersHandle hVariable = NumbersHandleNull;
	...
	*/
	...
	{
		NumbersHandle hInstance = NumbersHandleNull;

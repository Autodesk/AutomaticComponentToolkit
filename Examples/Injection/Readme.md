...
1. Reference-counting for all classes is now (v1.8.0-alpha) the default in ACT.
	...
	In addition:
	- The `releasemethod` now (v1.8.0-alpha) does not simple delete/free an instance of a class, but instead calls `DecRefCount`.

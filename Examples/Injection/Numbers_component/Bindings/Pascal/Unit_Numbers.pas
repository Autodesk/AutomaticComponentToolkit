...
**************************************************************************************************************************)
  ...
  begin
    ...
    if Assigned(HInstance) then
      Result := TNumbersVariable.Create(Self, HInstance);
  end;
  ...
  begin
    ...
    ResultHasError := 0;
    CheckError(nil, NumbersGetLastErrorFunc(AInstance.TheHandle, 0, bytesNeededErrorMessage, nil, ResultHasError));
    SetLength(bufferErrorMessage, bytesNeededErrorMessage);
    CheckError(nil, NumbersGetLastErrorFunc(AInstance.TheHandle, bytesNeededErrorMessage, bytesWrittenErrorMessage, @bufferErrorMessage[0], ResultHasError));
  ...
  begin
    if not Assigned(AInstance) then
      raise ENumbersException.CreateCustomMessage(NUMBERS_ERROR_INVALIDPARAM, 'AInstance is a nil value.');
    CheckError(nil, NumbersReleaseInstanceFunc(AInstance.TheHandle));
  end;
  ...
  begin
    if not Assigned(AInstance) then
      raise ENumbersException.CreateCustomMessage(NUMBERS_ERROR_INVALIDPARAM, 'AInstance is a nil value.');
    CheckError(nil, NumbersAcquireInstanceFunc(AInstance.TheHandle));
  end;

...
class NumbersHandle(ctypes.Structure):
	''' creates a struct to match NumbersHandle C type '''
...
class Wrapper:
	...
	def _loadFunctionTableFromMethod(self, symbolLookupMethodAddress):
		try:
			...
			methodType = ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.c_double, ctypes.POINTER(NumbersHandle))
			...
			if err != 0:
				raise ENumbersException(ErrorCodes.COULDNOTLOADLIBRARY, str(err))
			methodType = ctypes.CFUNCTYPE(ctypes.c_int32, NumbersHandle, ctypes.c_uint64, ctypes.POINTER(ctypes.c_uint64), ctypes.c_char_p, ctypes.POINTER(ctypes.c_bool))
			...
			if err != 0:
				raise ENumbersException(ErrorCodes.COULDNOTLOADLIBRARY, str(err))
			methodType = ctypes.CFUNCTYPE(ctypes.c_int32, NumbersHandle)
			...
			if err != 0:
				raise ENumbersException(ErrorCodes.COULDNOTLOADLIBRARY, str(err))
			methodType = ctypes.CFUNCTYPE(ctypes.c_int32, NumbersHandle, ctypes.POINTER(ctypes.c_uint64))
			...
			if err != 0:
				raise ENumbersException(ErrorCodes.COULDNOTLOADLIBRARY, str(err))
			methodType = ctypes.CFUNCTYPE(ctypes.c_int32, NumbersHandle, ctypes.POINTER(ctypes.c_double))
			...
			if err != 0:
				raise ENumbersException(ErrorCodes.COULDNOTLOADLIBRARY, str(err))
			methodType = ctypes.CFUNCTYPE(ctypes.c_int32, NumbersHandle, ctypes.c_double)
	...
	def _loadFunctionTable(self):
		try:
			...
			self.lib.numbers_createvariable.argtypes = [ctypes.c_double, ctypes.POINTER(NumbersHandle)]
			...
			self.lib.numbers_getlasterror.argtypes = [NumbersHandle, ctypes.c_uint64, ctypes.POINTER(ctypes.c_uint64), ctypes.c_char_p, ctypes.POINTER(ctypes.c_bool)]
			
			self.lib.numbers_releaseinstance.restype = ctypes.c_int32
			self.lib.numbers_releaseinstance.argtypes = [NumbersHandle]
			
			self.lib.numbers_acquireinstance.restype = ctypes.c_int32
			self.lib.numbers_acquireinstance.argtypes = [NumbersHandle]
			...
			self.lib.numbers_base_classtypeid.argtypes = [NumbersHandle, ctypes.POINTER(ctypes.c_uint64)]
			
			self.lib.numbers_variable_getvalue.restype = ctypes.c_int32
			self.lib.numbers_variable_getvalue.argtypes = [NumbersHandle, ctypes.POINTER(ctypes.c_double)]
			
			self.lib.numbers_variable_setvalue.restype = ctypes.c_int32
			self.lib.numbers_variable_setvalue.argtypes = [NumbersHandle, ctypes.c_double]

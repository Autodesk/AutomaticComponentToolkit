...
int main()
{
	try
	{
		std::string libpath = (""); // TODO: put the location of the Numbers-library file here.
		auto wrapper = Numbers::CWrapper::loadLibrary(libpath + "/numbers."); // TODO: add correct suffix of the library

...
NumbersResult _numbers_getprocaddress_internal(const char * pProcName, void ** ppProcAddress)
{
	...
	if (!sbProcAddressMapHasBeenInitialized) {
		sProcAddressMap["numbers_variable_getvalue"] = &numbers_variable_getvalue;
		sProcAddressMap["numbers_variable_setvalue"] = &numbers_variable_setvalue;
		sProcAddressMap["numbers_createvariable"] = &numbers_createvariable;
		sProcAddressMap["numbers_getversion"] = &numbers_getversion;
		sProcAddressMap["numbers_getlasterror"] = &numbers_getlasterror;
		sProcAddressMap["numbers_releaseinstance"] = &numbers_releaseinstance;
		sProcAddressMap["numbers_acquireinstance"] = &numbers_acquireinstance;
		sProcAddressMap["numbers_getsymbollookupmethod"] = &numbers_getsymbollookupmethod;

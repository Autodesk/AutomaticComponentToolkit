...
**************************************************************************************************************************)
  ...
  *)
  TCalculatorBase_ClassTypeIdFunc = function(pBase: TCalculatorHandle; out pClassTypeId: QWord): TCalculatorResult; cdecl;
...
**************************************************************************************************************************)
  ...
  private
    FModule: HMODULE;
    FCalculatorBase_ClassTypeIdFunc: TCalculatorBase_ClassTypeIdFunc;
  ...
  protected
    property CalculatorBase_ClassTypeIdFunc: TCalculatorBase_ClassTypeIdFunc read FCalculatorBase_ClassTypeIdFunc;
  ...
  TCalculatorPolymorphicFactory<_T:class; _B> = record
    class function Make(Wrapper: TCalculatorWrapper; Handle: TCalculatorHandle): _T; static;
  end;
  function TCalculatorPolymorphicFactoryMakeBase(Wrapper: TCalculatorWrapper; Handle: TCalculatorHandle): TCALCULATORBase;
  function TCalculatorPolymorphicFactoryMakeVariable(Wrapper: TCalculatorWrapper; Handle: TCalculatorHandle): TCALCULATORVariable;
  function TCalculatorPolymorphicFactoryMakeCalculator(Wrapper: TCalculatorWrapper; Handle: TCalculatorHandle): TCALCULATORCalculator;
...
**************************************************************************************************************************)
   ...
   *            TCALCULATORWrapper::AcquireInstance(object: TCALCULATORBase) must be called after instantiating new object.
   *            This is important to keep reference count matching between application and library sides.
  *)
  class function TCalculatorPolymorphicFactory<_T, _B>.Make(Wrapper: TCalculatorWrapper; Handle: TCalculatorHandle): _T;
  var
    ClassTypeId: QWord;
    Obj: TCALCULATORBase;
  begin
    Result := nil;
    Wrapper.CheckError(nil, Wrapper.CalculatorBase_ClassTypeIdFunc(handle, ClassTypeId));
    case (ClassTypeId) of
      QWord($DDEA9DC03BDC9EC4): begin Obj := TCALCULATORBase.Create(Wrapper, Handle); if Obj.inheritsFrom(_T) then Result := Obj as _T; end; // First 64 bits of SHA1 of a string: "Calculator::Base"
      QWord($C228BBEB32E22A34): begin Obj := TCALCULATORVariable.Create(Wrapper, Handle); if Obj.inheritsFrom(_T) then Result := Obj as _T; end; // First 64 bits of SHA1 of a string: "Calculator::Variable"
      QWord($5FA5D809D8A728B0): begin Obj := TCALCULATORCalculator.Create(Wrapper, Handle); if Obj.inheritsFrom(_T) then Result := Obj as _T; end; // First 64 bits of SHA1 of a string: "Calculator::Calculator"
    end;
    if Result = nil then Result := _B.Create(Wrapper, Handle);
  end;
  function TCalculatorPolymorphicFactoryMakeBase(Wrapper: TCalculatorWrapper; Handle: TCalculatorHandle): TCALCULATORBase;
  begin
    Result := TCalculatorPolymorphicFactory<TCALCULATORBase, TCALCULATORBase>.Make(Wrapper, Handle);
  end;
  function TCalculatorPolymorphicFactoryMakeVariable(Wrapper: TCalculatorWrapper; Handle: TCalculatorHandle): TCALCULATORVariable;
  begin
    Result := TCalculatorPolymorphicFactory<TCALCULATORVariable, TCALCULATORVariable>.Make(Wrapper, Handle);
  end;
  function TCalculatorPolymorphicFactoryMakeCalculator(Wrapper: TCalculatorWrapper; Handle: TCalculatorHandle): TCALCULATORCalculator;
  begin
    Result := TCalculatorPolymorphicFactory<TCALCULATORCalculator, TCALCULATORCalculator>.Make(Wrapper, Handle);
  end;
...
**************************************************************************************************************************)
  ...
  begin
    FWrapper.CheckError(Self, FWrapper.CalculatorBase_ClassTypeIdFunc(FHandle, Result));
  end;
...
**************************************************************************************************************************)
  ...
  begin
    ...
    if Assigned(HVariable) then
      Result := TCalculatorPolymorphicFactory<TCalculatorVariable, TCalculatorVariable>.Make(FWrapper, HVariable);
  end;
  ...
  begin
    ...
    if Assigned(HInstance) then
      Result := TCalculatorPolymorphicFactory<TCalculatorVariable, TCalculatorVariable>.Make(FWrapper, HInstance);
  end;
...
**************************************************************************************************************************)
  ...
  begin
    ...
    FCalculatorBase_ClassTypeIdFunc := LoadFunction('calculator_base_classtypeid');
  ...
  begin
    ...
    AResult := ALookupMethod(PAnsiChar('calculator_base_classtypeid'), @FCalculatorBase_ClassTypeIdFunc);
  ...
  begin
    ...
    if Assigned(HInstance) then
      Result := TCalculatorPolymorphicFactory<TCalculatorVariable, TCalculatorVariable>.Make(Self, HInstance);
  end;
  ...
  begin
    ...
    if Assigned(HInstance) then
      Result := TCalculatorPolymorphicFactory<TCalculatorCalculator, TCalculatorCalculator>.Make(Self, HInstance);
  end;

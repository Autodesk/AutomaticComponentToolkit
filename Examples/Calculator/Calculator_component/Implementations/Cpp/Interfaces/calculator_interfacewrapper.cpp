...
**************************************************************************************************************************/
CalculatorResult calculator_base_classtypeid(Calculator_Base pBase, Calculator_uint64 * pClassTypeId)
{
...
CalculatorResult Calculator::Impl::Calculator_GetProcAddress (const char * pProcName, void ** ppProcAddress)
{
	...
	*ppProcAddress = nullptr;
	...
	if (sProcName == "calculator_base_classtypeid") 
		*ppProcAddress = (void*) &calculator_base_classtypeid;
	if (sProcName == "calculator_variable_getvalue") 
		*ppProcAddress = (void*) &calculator_variable_getvalue;
	if (sProcName == "calculator_variable_setvalue") 
		*ppProcAddress = (void*) &calculator_variable_setvalue;
	if (sProcName == "calculator_calculator_enlistvariable") 
		*ppProcAddress = (void*) &calculator_calculator_enlistvariable;
	if (sProcName == "calculator_calculator_getenlistedvariable") 
		*ppProcAddress = (void*) &calculator_calculator_getenlistedvariable;
	if (sProcName == "calculator_calculator_clearvariables") 
		*ppProcAddress = (void*) &calculator_calculator_clearvariables;
	if (sProcName == "calculator_calculator_multiply") 
		*ppProcAddress = (void*) &calculator_calculator_multiply;
	if (sProcName == "calculator_calculator_add") 
		*ppProcAddress = (void*) &calculator_calculator_add;
	if (sProcName == "calculator_getversion") 
		*ppProcAddress = (void*) &calculator_getversion;
	if (sProcName == "calculator_getlasterror") 
		*ppProcAddress = (void*) &calculator_getlasterror;
	if (sProcName == "calculator_releaseinstance") 
		*ppProcAddress = (void*) &calculator_releaseinstance;
	if (sProcName == "calculator_acquireinstance") 
		*ppProcAddress = (void*) &calculator_acquireinstance;
	if (sProcName == "calculator_createvariable") 
		*ppProcAddress = (void*) &calculator_createvariable;
	if (sProcName == "calculator_createcalculator") 
		*ppProcAddress = (void*) &calculator_createcalculator;

...
public:
	...
	*/
	virtual Calculator_uint64 ClassTypeId() = 0;
};
...
public:
	...
	* @return Class type as a 64 bits integer
	*/
	Calculator_uint64 ClassTypeId() override
	{
		return 0xC228BBEB32E22A34UL; // First 64 bits of SHA1 of a string: "Calculator::Variable"
	}
...
public:
	...
	*/
	Calculator_uint64 ClassTypeId() override
	{
		return 0x5FA5D809D8A728B0UL; // First 64 bits of SHA1 of a string: "Calculator::Calculator"
	}
...
public:
	...
	*/
	...
	/**
	* Icalculator::ReleaseInstance - Releases shared ownership of an Instance
	* @param[in] pInstance - Instance Handle
	*/
	static void ReleaseInstance(IBase* pInstance);

	/**
	* Icalculator::AcquireInstance - Acquires shared ownership of an Instance
	* @param[in] pInstance - Instance Handle
	*/
...
CalculatorResult Calculator_GetProcAddress (const char * pProcName, void ** ppProcAddress);

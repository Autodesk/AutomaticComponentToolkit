...
CalculationResult calculation_base_releaseinstance(Calculation_Base pBase)
{
	IBase* pIBaseClass = (IBase *)pBase.m_hHandle;
...
CalculationResult calculation_base_acquireinstance(Calculation_Base pBase)
{
	IBase* pIBaseClass = (IBase *)pBase.m_hHandle;
...
CalculationResult calculation_calculator_getenlistedvariable(Calculation_Calculator pCalculator, Calculation_uint32 nIndex, Numbers_Variable * pVariable)
{
	...
	try {
		...
		// TODO: this does not work necessarily@ pBaseVariable might be nullptr
		pNumbersVariable->AcquireInstance();
...
CalculationResult _calculation_getprocaddress_base(const char * pProcName, void ** ppProcAddress)
{
	static bool sbProcAddressMapHasBeenInitialized = false;
	static std::map<std::string, void*> sProcAddressMap;
	if (!sbProcAddressMapHasBeenInitialized) {
...
/*************************************************************************************************************************
 Function table lookup implementation for class Calculator
**************************************************************************************************************************/

CalculationResult _calculation_getprocaddress_calculator(const char * pProcName, void ** ppProcAddress)
{
	static bool sbProcAddressMapHasBeenInitialized = false;
	static std::map<std::string, void*> sProcAddressMap;
	if (!sbProcAddressMapHasBeenInitialized) {

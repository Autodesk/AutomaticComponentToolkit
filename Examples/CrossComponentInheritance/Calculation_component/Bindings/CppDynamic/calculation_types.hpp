...
typedef CalculationResult(*CalculationSymbolLookupType)(const char*, void**);
...
typedef struct {
  CalculationHandle m_hHandle;
  CalculationSymbolLookupType m_pfnSymbolLookupMethod;
} CalculationExtendedHandle;

typedef CalculationExtendedHandle Calculation_Base;
typedef CalculationExtendedHandle Calculation_Calculator;

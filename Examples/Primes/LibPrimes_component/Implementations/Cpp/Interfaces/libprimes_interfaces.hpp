...
/*************************************************************************************************************************
 Class interface for LibPrimesBase 
**************************************************************************************************************************/

class ILibPrimesBase {
public:
	/**
	* ILibPrimesBase::~ILibPrimesBase - virtual destructor of ILibPrimesBase
	*/
	virtual ~ILibPrimesBase() {};
...
class ILibPrimesCalculator : public virtual ILibPrimesBase{
public:
	/**
...
class ILibPrimesFactorizationCalculator : public virtual ILibPrimesBase, public virtual ILibPrimesCalculator{
public:
	/**
...
class ILibPrimesSieveCalculator : public virtual ILibPrimesBase, public virtual ILibPrimesCalculator{
public:
	/**
...
public:
	...
	*/
	static bool GetLastError (ILibPrimesBase* pInstance, std::string & sErrorMessage);

	/**
	* Ilibprimes::ReleaseInstance - Releases the memory of an Instance
	* @param[in] pInstance - Instance Handle
	*/
	static void ReleaseInstance (ILibPrimesBase* pInstance);

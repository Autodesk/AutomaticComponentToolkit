...
public:
	...
	*/
	virtual LibPrimes_uint64 ClassTypeId() = 0;
};
...
public:
	...
	* @return Class type as a 64 bits integer
	*/
	LibPrimes_uint64 ClassTypeId() override
	{
		return 0x11F9CFC626592744UL; // First 64 bits of SHA1 of a string: "LibPrimes::Calculator"
	}
...
public:
	/**
	* IFactorizationCalculator::ClassTypeId - Get Class Type Id
	* @return Class type as a 64 bits integer
	*/
	LibPrimes_uint64 ClassTypeId() override
	{
		return 0x6C7A0FD2ECC65118UL; // First 64 bits of SHA1 of a string: "LibPrimes::FactorizationCalculator"
	}
...
public:
	/**
	* ISieveCalculator::ClassTypeId - Get Class Type Id
	* @return Class type as a 64 bits integer
	*/
	LibPrimes_uint64 ClassTypeId() override
	{
		return 0x58F1CCC31D38375BUL; // First 64 bits of SHA1 of a string: "LibPrimes::SieveCalculator"
	}
...
LibPrimesResult LibPrimes_GetProcAddress (const char * pProcName, void ** ppProcAddress);

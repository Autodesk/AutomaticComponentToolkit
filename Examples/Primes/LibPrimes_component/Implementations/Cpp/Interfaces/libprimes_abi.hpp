...
* @return error code or 0 (success)
*/
LIBPRIMES_DECLSPEC LibPrimesResult libprimes_calculator_getself(LibPrimes_Calculator pCalculator, LibPrimes_Calculator * pValue);

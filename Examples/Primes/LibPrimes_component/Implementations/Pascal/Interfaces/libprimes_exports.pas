...
* @return error code or 0 (success)
*)
function libprimes_factorizationcalculator_getprimefactors (pFactorizationCalculator: TLibPrimesHandle; nPrimeFactorsCount: Cardinal; pPrimeFactorsNeededCount: PCardinal; pPrimeFactorsBuffer: PLibPrimesPrimeFactor): TLibPrimesResult; cdecl;
...
* @return error code or 0 (success)
*)
function libprimes_sievecalculator_getprimes (pSieveCalculator: TLibPrimesHandle; nPrimesCount: Cardinal; pPrimesNeededCount: PCardinal; pPrimesBuffer: PQWord): TLibPrimesResult; cdecl;

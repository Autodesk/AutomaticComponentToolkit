...
const
  ...
  LIBPRIMES_VERSION_PRERELEASEINFO = 'alpha';
  LIBPRIMES_VERSION_BUILDINFO = '23';
...
type
  ...
  TLibPrimesProgressIdentifier = (
    eProgressIdentifierNoOp,
    eProgressIdentifierStarting,
    eProgressIdentifierRunning,
...
type
  ...
  PLibPrimes_ProgressCallback = function(const fProgressPercentage: Single; const eTheProgressIdentifier: Integer; out pShouldAbort: Byte): Integer; cdecl;
...
**************************************************************************************************************************)
  ...
  * @return error code or 0 (success)
  *)
  TLibPrimesCalculator_GetSelfFunc = function (pCalculator: TLibPrimesHandle; out pValue: TLibPrimesHandle): TLibPrimesResult; cdecl;
...
**************************************************************************************************************************)
  ...
  public
    ...
    function GetSelf(): TLibPrimesCalculator;
...
**************************************************************************************************************************)
  ...
  private
    ...
    FLibPrimesCalculator_GetSelfFunc: TLibPrimesCalculator_GetSelfFunc;
  ...
  protected
    ...
    property LibPrimesCalculator_GetSelfFunc: TLibPrimesCalculator_GetSelfFunc read FLibPrimesCalculator_GetSelfFunc;
...
**************************************************************************************************************************)
  ...
  function convertProgressIdentifierToConst (const AValue: TLibPrimesProgressIdentifier): Integer;
  function convertConstToProgressIdentifier (const AValue: Integer): TLibPrimesProgressIdentifier;
...
**************************************************************************************************************************)
  ...
  begin
    case AValue of
      eProgressIdentifierNoOp: Result := -1;
      eProgressIdentifierStarting: Result := 0;
      eProgressIdentifierRunning: Result := 1;
      eProgressIdentifierDone: Result := 2;
      else 
        raise ELibPrimesException.CreateCustomMessage (LIBPRIMES_ERROR_INVALIDPARAM, 'invalid enum value');
    end;
  end;
  ...
  begin
    case AValue of
      -1: Result := eProgressIdentifierNoOp;
      0: Result := eProgressIdentifierStarting;
      1: Result := eProgressIdentifierRunning;
      2: Result := eProgressIdentifierDone;
      else 
        raise ELibPrimesException.CreateCustomMessage (LIBPRIMES_ERROR_INVALIDPARAM, 'invalid enum constant');
    end;
  end;
...
**************************************************************************************************************************)
  ...
  function TLibPrimesCalculator.GetSelf(): TLibPrimesCalculator;
  var
    HValue: TLibPrimesHandle;
  begin
    Result := nil;
    HValue := nil;
    FWrapper.CheckError (Self, FWrapper.LibPrimesCalculator_GetSelfFunc (FHandle, HValue));
    if Assigned (HValue) then
      Result := TLibPrimesCalculator.Create (FWrapper, HValue);
  end;
...
**************************************************************************************************************************)
  ...
  begin
    ...
    FLibPrimesCalculator_GetSelfFunc := LoadFunction ('libprimes_calculator_getself');

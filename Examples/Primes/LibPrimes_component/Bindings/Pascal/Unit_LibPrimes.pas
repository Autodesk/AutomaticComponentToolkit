...
**************************************************************************************************************************)
    ...
    * @return error code or 0 (success)
    *)
    TLibPrimesFactorizationCalculator_GetPrimeFactorsFunc = function (pFactorizationCalculator: TLibPrimesHandle; const nPrimeFactorsCount: Cardinal; out pPrimeFactorsNeededCount: Cardinal; pPrimeFactorsBuffer: PLibPrimesPrimeFactor): TLibPrimesResult; cdecl;
...
**************************************************************************************************************************)
    ...
    * @return error code or 0 (success)
    *)
    TLibPrimesSieveCalculator_GetPrimesFunc = function (pSieveCalculator: TLibPrimesHandle; const nPrimesCount: Cardinal; out pPrimesNeededCount: Cardinal; pPrimesBuffer: PQWord): TLibPrimesResult; cdecl;
...
**************************************************************************************************************************)
    ...
    var
        countNeededPrimeFactors: Cardinal;
        countWrittenPrimeFactors: Cardinal;
    begin
...
**************************************************************************************************************************)
    ...
    var
        countNeededPrimes: Cardinal;
        countWrittenPrimes: Cardinal;
    begin
        countNeededPrimes:= 0;

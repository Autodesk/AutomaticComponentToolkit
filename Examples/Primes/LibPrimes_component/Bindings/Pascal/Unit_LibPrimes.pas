...
**************************************************************************************************************************)
  ...
  *)
  TLibPrimesBase_ClassTypeIdFunc = function(pBase: TLibPrimesHandle; out pClassTypeId: QWord): TLibPrimesResult; cdecl;
...
**************************************************************************************************************************)
  ...
  * @return error code or 0 (success)
  *)
  TLibPrimesAcquireInstanceFunc = function(const pInstance: TLibPrimesHandle): TLibPrimesResult; cdecl;
...
**************************************************************************************************************************)
TLibPrimesSymbolLookupMethod = function(const pSymbolName: PAnsiChar; out pValue: Pointer): TLibPrimesResult; cdecl;
...
**************************************************************************************************************************)
 ...
 TLibPrimesBase = class(TObject)
  ...
  public
    ...
    property TheHandle: TLibPrimesHandle read FHandle;
...
**************************************************************************************************************************)
  ...
  private
    FModule: HMODULE;
    FLibPrimesBase_ClassTypeIdFunc: TLibPrimesBase_ClassTypeIdFunc;
    ...
    FLibPrimesAcquireInstanceFunc: TLibPrimesAcquireInstanceFunc;
  ...
  protected
    property LibPrimesBase_ClassTypeIdFunc: TLibPrimesBase_ClassTypeIdFunc read FLibPrimesBase_ClassTypeIdFunc;
    ...
    property LibPrimesAcquireInstanceFunc: TLibPrimesAcquireInstanceFunc read FLibPrimesAcquireInstanceFunc;
  ...
  public
    ...
    constructor CreateFromSymbolLookupMethod(ALookupMethod: TLibPrimesSymbolLookupMethod);
    destructor Destroy; override;
    ...
    procedure AcquireInstance(const AInstance: TLibPrimesBase);
  ...
  TLibPrimesPolymorphicFactory<_T:class; _B> = record
    class function Make(Wrapper: TLibPrimesWrapper; Handle: TLibPrimesHandle): _T; static;
  end;
  function TLibPrimesPolymorphicFactoryMakeBase(Wrapper: TLibPrimesWrapper; Handle: TLibPrimesHandle): TLIBPRIMESBase;
  function TLibPrimesPolymorphicFactoryMakeCalculator(Wrapper: TLibPrimesWrapper; Handle: TLibPrimesHandle): TLIBPRIMESCalculator;
  function TLibPrimesPolymorphicFactoryMakeFactorizationCalculator(Wrapper: TLibPrimesWrapper; Handle: TLibPrimesHandle): TLIBPRIMESFactorizationCalculator;
  function TLibPrimesPolymorphicFactoryMakeSieveCalculator(Wrapper: TLibPrimesWrapper; Handle: TLibPrimesHandle): TLIBPRIMESSieveCalculator;
...
**************************************************************************************************************************)
   ...
   *            TLIBPRIMESWrapper::AcquireInstance(object: TLIBPRIMESBase) must be called after instantiating new object.
   *            This is important to keep reference count matching between application and library sides.
  *)
  class function TLibPrimesPolymorphicFactory<_T, _B>.Make(Wrapper: TLibPrimesWrapper; Handle: TLibPrimesHandle): _T;
  var
    ClassTypeId: QWord;
    Obj: TLIBPRIMESBase;
  begin
    Result := nil;
    Wrapper.CheckError(nil, Wrapper.LibPrimesBase_ClassTypeIdFunc(handle, ClassTypeId));
    case (ClassTypeId) of
      QWord($8769D2BB89D05D4D): begin Obj := TLIBPRIMESBase.Create(Wrapper, Handle); if Obj.inheritsFrom(_T) then Result := Obj as _T; end; // First 64 bits of SHA1 of a string: "LibPrimes::Base"
      QWord($11F9CFC626592744): begin Obj := TLIBPRIMESCalculator.Create(Wrapper, Handle); if Obj.inheritsFrom(_T) then Result := Obj as _T; end; // First 64 bits of SHA1 of a string: "LibPrimes::Calculator"
      QWord($6C7A0FD2ECC65118): begin Obj := TLIBPRIMESFactorizationCalculator.Create(Wrapper, Handle); if Obj.inheritsFrom(_T) then Result := Obj as _T; end; // First 64 bits of SHA1 of a string: "LibPrimes::FactorizationCalculator"
      QWord($58F1CCC31D38375B): begin Obj := TLIBPRIMESSieveCalculator.Create(Wrapper, Handle); if Obj.inheritsFrom(_T) then Result := Obj as _T; end; // First 64 bits of SHA1 of a string: "LibPrimes::SieveCalculator"
    end;
    if Result = nil then Result := _B.Create(Wrapper, Handle);
  end;
  function TLibPrimesPolymorphicFactoryMakeBase(Wrapper: TLibPrimesWrapper; Handle: TLibPrimesHandle): TLIBPRIMESBase;
  begin
    Result := TLibPrimesPolymorphicFactory<TLIBPRIMESBase, TLIBPRIMESBase>.Make(Wrapper, Handle);
  end;
  function TLibPrimesPolymorphicFactoryMakeCalculator(Wrapper: TLibPrimesWrapper; Handle: TLibPrimesHandle): TLIBPRIMESCalculator;
  begin
    Result := TLibPrimesPolymorphicFactory<TLIBPRIMESCalculator, TLIBPRIMESCalculator>.Make(Wrapper, Handle);
  end;
  function TLibPrimesPolymorphicFactoryMakeFactorizationCalculator(Wrapper: TLibPrimesWrapper; Handle: TLibPrimesHandle): TLIBPRIMESFactorizationCalculator;
  begin
    Result := TLibPrimesPolymorphicFactory<TLIBPRIMESFactorizationCalculator, TLIBPRIMESFactorizationCalculator>.Make(Wrapper, Handle);
  end;
  function TLibPrimesPolymorphicFactoryMakeSieveCalculator(Wrapper: TLibPrimesWrapper; Handle: TLibPrimesHandle): TLIBPRIMESSieveCalculator;
  begin
    Result := TLibPrimesPolymorphicFactory<TLIBPRIMESSieveCalculator, TLIBPRIMESSieveCalculator>.Make(Wrapper, Handle);
  end;
...
**************************************************************************************************************************)
  ...
  function TLibPrimesBase.ClassTypeId(): QWord;
  begin
    FWrapper.CheckError(Self, FWrapper.LibPrimesBase_ClassTypeIdFunc(FHandle, Result));
  end;
...
**************************************************************************************************************************)
  ...
  begin
    ...
    FLibPrimesBase_ClassTypeIdFunc := LoadFunction('libprimes_base_classtypeid');
    ...
    FLibPrimesAcquireInstanceFunc := LoadFunction('libprimes_acquireinstance');
  ...
  constructor TLibPrimesWrapper.CreateFromSymbolLookupMethod(ALookupMethod: TLibPrimesSymbolLookupMethod);
  var
    AResult : TLibPrimesResult;
  begin
    inherited Create;
    
    
    AResult := ALookupMethod(PAnsiChar('libprimes_base_classtypeid'), @FLibPrimesBase_ClassTypeIdFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_calculator_getvalue'), @FLibPrimesCalculator_GetValueFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_calculator_setvalue'), @FLibPrimesCalculator_SetValueFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_calculator_calculate'), @FLibPrimesCalculator_CalculateFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_calculator_setprogresscallback'), @FLibPrimesCalculator_SetProgressCallbackFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_factorizationcalculator_getprimefactors'), @FLibPrimesFactorizationCalculator_GetPrimeFactorsFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_sievecalculator_getprimes'), @FLibPrimesSieveCalculator_GetPrimesFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_getversion'), @FLibPrimesGetVersionFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_getlasterror'), @FLibPrimesGetLastErrorFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_acquireinstance'), @FLibPrimesAcquireInstanceFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_releaseinstance'), @FLibPrimesReleaseInstanceFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_createfactorizationcalculator'), @FLibPrimesCreateFactorizationCalculatorFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_createsievecalculator'), @FLibPrimesCreateSieveCalculatorFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
    AResult := ALookupMethod(PAnsiChar('libprimes_setjournal'), @FLibPrimesSetJournalFunc);
    if AResult <> LIBPRIMES_SUCCESS then
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_COULDNOTLOADLIBRARY, '');
  ...
  var
    AInstanceHandle: TLibPrimesHandle;
  ...
  begin
    ...
    ResultHasError := 0;
    CheckError(nil, LibPrimesGetLastErrorFunc(AInstanceHandle, 0, bytesNeededErrorMessage, nil, ResultHasError));
    SetLength(bufferErrorMessage, bytesNeededErrorMessage);
    CheckError(nil, LibPrimesGetLastErrorFunc(AInstanceHandle, bytesNeededErrorMessage, bytesWrittenErrorMessage, @bufferErrorMessage[0], ResultHasError));
    AErrorMessage := StrPas(@bufferErrorMessage[0]);
    Result := (ResultHasError <> 0);
  end;

  procedure TLibPrimesWrapper.AcquireInstance(const AInstance: TLibPrimesBase);
  var
    AInstanceHandle: TLibPrimesHandle;
  begin
    if Assigned(AInstance) then
    AInstanceHandle := AInstance.TheHandle
      ...
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_INVALIDPARAM, 'AInstance is a nil value.');
    CheckError(nil, LibPrimesAcquireInstanceFunc(AInstanceHandle));
  end;
  ...
  begin
    ...
    AInstanceHandle := AInstance.TheHandle
      ...
      raise ELibPrimesException.CreateCustomMessage(LIBPRIMES_ERROR_INVALIDPARAM, 'AInstance is a nil value.');
    CheckError(nil, LibPrimesReleaseInstanceFunc(AInstanceHandle));
  end;
  ...
  begin
    ...
    if Assigned(HInstance) then
      Result := TLibPrimesPolymorphicFactory<TLibPrimesFactorizationCalculator, TLibPrimesFactorizationCalculator>.Make(Self, HInstance);
  end;
  ...
  begin
    ...
    if Assigned(HInstance) then
      Result := TLibPrimesPolymorphicFactory<TLibPrimesSieveCalculator, TLibPrimesSieveCalculator>.Make(Self, HInstance);
  end;

...
This file has been generated by the Automatic Component Toolkit (ACT) version 1.3.3.
...
**************************************************************************************************************************)
    ...
    * @return error code or 0 (success)
    *)
    TLibPrimesFactorizationCalculator_CheckPrimeFactorsFunc = function (pFactorizationCalculator: TLibPrimesHandle; const nPrimeFactorsCount: QWord; const pPrimeFactorsBuffer: PLibPrimesPrimeFactor; out pAreEqual: Cardinal): TLibPrimesResult; cdecl;
...
**************************************************************************************************************************)
    ...
    public
        ...
        function CheckPrimeFactors(const APrimeFactors: ArrayOfLibPrimesPrimeFactor): Boolean;
    end;
...
**************************************************************************************************************************)
    ...
    private
        ...
        FLibPrimesFactorizationCalculator_CheckPrimeFactorsFunc: TLibPrimesFactorizationCalculator_CheckPrimeFactorsFunc;
    ...
    protected
        ...
        property LibPrimesFactorizationCalculator_CheckPrimeFactorsFunc: TLibPrimesFactorizationCalculator_CheckPrimeFactorsFunc read FLibPrimesFactorizationCalculator_CheckPrimeFactorsFunc;
...
**************************************************************************************************************************)
    ...
    function TLibPrimesFactorizationCalculator.CheckPrimeFactors(const APrimeFactors: ArrayOfLibPrimesPrimeFactor): Boolean;
    var
        PtrPrimeFactors: PLibPrimesPrimeFactor;
        LenPrimeFactors: QWord;
        ResultAreEqual: Cardinal;
    begin
        LenPrimeFactors := Length (APrimeFactors);
        if LenPrimeFactors > $FFFFFFFF then
            raise ELibPrimesException.CreateCustomMessage (LIBPRIMES_ERROR_INVALIDPARAM, 'array has too many entries.');
        if LenPrimeFactors > 0 then
            PtrPrimeFactors := @APrimeFactors[0]
        else
            PtrPrimeFactors := nil;
    
        ResultAreEqual := 0;
        FWrapper.CheckError (Self, FWrapper.LibPrimesFactorizationCalculator_CheckPrimeFactorsFunc (FHandle, QWord (LenPrimeFactors), PtrPrimeFactors, ResultAreEqual));
        Result := (ResultAreEqual <> 0);
    end;
...
**************************************************************************************************************************)
    ...
    begin
        ...
        FLibPrimesFactorizationCalculator_CheckPrimeFactorsFunc := LoadFunction ('libprimes_factorizationcalculator_checkprimefactors');
    ...
    procedure TLibPrimesWrapper.CheckVersion();
    var

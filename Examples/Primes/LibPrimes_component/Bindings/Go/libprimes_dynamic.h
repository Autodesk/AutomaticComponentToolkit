...
*/
typedef LibPrimesResult (*PLibPrimesBase_ClassTypeIdPtr) (LibPrimes_Base pBase, LibPrimes_uint64 * pClassTypeId);
...
* @return error code or 0 (success)
*/
typedef LibPrimesResult (*PLibPrimesAcquireInstancePtr) (LibPrimes_Base pInstance);
...
typedef struct {
	...
	PLibPrimesBase_ClassTypeIdPtr m_Base_ClassTypeId;
	...
	PLibPrimesAcquireInstancePtr m_AcquireInstance;

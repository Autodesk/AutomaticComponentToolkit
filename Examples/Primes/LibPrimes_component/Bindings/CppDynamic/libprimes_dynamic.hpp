...
public:
	...
	CLibPrimesWrapper (const std::string &sFileName)
	{
		...
		CheckError(nullptr, CheckVersion());
	}
...
public:
	...
	*/
	...
	bool CLibPrimesFactorizationCalculator::CheckPrimeFactors (const CLibPrimesInputVector<sLibPrimesPrimeFactor> & PrimeFactorsBuffer)
	{
		bool resultAreEqual = 0;
		CheckError ( m_pWrapper->m_WrapperTable.m_FactorizationCalculator_CheckPrimeFactors (m_pHandle, (LibPrimes_uint64)PrimeFactorsBuffer.size(), PrimeFactorsBuffer.data(), &resultAreEqual) );

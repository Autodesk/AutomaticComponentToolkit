...
**************************************************************************************************************************/
class ELibPrimesException : public std::runtime_error {
protected:
	/**
...
public:
	...
	void CheckError(LibPrimesHandle handle, LibPrimesResult nResult)
	{
		...
		void GetLibraryVersion (unsigned int & nMajor, unsigned int & nMinor, unsigned int & nMicro);
...
public:
	...
	*/
	void GetPrimes (std::vector<unsigned long long> & PrimesBuffer)
	{
	...
	*/
	inline void CLibPrimesWrapper::GetLibraryVersion (unsigned int & nMajor, unsigned int & nMinor, unsigned int & nMicro)
	{

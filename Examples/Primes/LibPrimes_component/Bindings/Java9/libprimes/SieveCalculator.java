...
public class SieveCalculator extends Calculator {
	...
	public long[] getPrimes() throws LibPrimesException {
		Pointer countNeededPrimes = new Memory(8);
		mWrapper.checkError(this, mWrapper.libprimes_sievecalculator_getprimes.invokeInt(new java.lang.Object[]{mHandle, 0L, countNeededPrimes, Pointer.NULL}));
		long countPrimes = countNeededPrimes.getLong(0);
		...
		return bufferPrimes.getLongArray(0, (int)countPrimes);
	}

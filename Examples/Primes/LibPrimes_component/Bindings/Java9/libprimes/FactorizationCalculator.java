...
public class FactorizationCalculator extends Calculator {
	...
	public PrimeFactor[] getPrimeFactors() throws LibPrimesException {
		Pointer countNeededPrimeFactors = new Memory(8);
		mWrapper.checkError(this, mWrapper.libprimes_factorizationcalculator_getprimefactors.invokeInt(new java.lang.Object[]{mHandle, 0L, countNeededPrimeFactors, null}));
		long countPrimeFactors = countNeededPrimeFactors.getLong(0);
		...
		PrimeFactor primeFactors[] = new PrimeFactor[(int)countPrimeFactors];
		for (int i = 0; i < (int)countPrimeFactors; i++) {

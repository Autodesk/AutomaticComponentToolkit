...
public class Base {
	 ...
	 */
	public long classTypeId() throws LibPrimesException {
		Pointer bufferClassTypeId = new Memory(8);
		mWrapper.checkError(this, mWrapper.libprimes_base_classtypeid.invokeInt(new java.lang.Object[]{mHandle, bufferClassTypeId}));

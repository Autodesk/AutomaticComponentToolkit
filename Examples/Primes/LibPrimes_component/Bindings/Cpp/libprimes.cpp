...
bool CLibPrimesFactorizationCalculator::CheckPrimeFactors (const CLibPrimesInputVector<sLibPrimesPrimeFactor> & PrimeFactorsBuffer)
{
	...
	CheckError ( libprimes_factorizationcalculator_checkprimefactors (m_pHandle, (LibPrimes_uint64)PrimeFactorsBuffer.size(), PrimeFactorsBuffer.data(), &resultAreEqual) );

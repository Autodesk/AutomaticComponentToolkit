...
*/
void CLibPrimesBase::CheckError(LibPrimesResult nResult)
{
	CLibPrimesWrapper::CheckError(this, nResult);
}

CLibPrimesBase::CLibPrimesBase(LibPrimesHandle pHandle)
	: m_pHandle (pHandle)
{
}

CLibPrimesBase::~CLibPrimesBase()
{
	CLibPrimesWrapper::ReleaseInstance(this);
}

LibPrimesHandle CLibPrimesBase::GetHandle()
{
	return m_pHandle;
}
...
*/
bool CLibPrimesWrapper::GetLastError (CLibPrimesBase * pInstance, std::string & sErrorMessage)
{
...
* @param[in] pInstance - Instance Handle
*/
void CLibPrimesWrapper::ReleaseInstance (CLibPrimesBase * pInstance)
{
	LibPrimesHandle hInstance = nullptr;
	if (pInstance != nullptr) {
		hInstance = pInstance->GetHandle ();
...
void CLibPrimesWrapper::CheckError(CLibPrimesBase * pBaseClass, LibPrimesResult nResult)
{
	if (nResult != 0) {

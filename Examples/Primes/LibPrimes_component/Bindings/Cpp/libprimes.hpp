...
public:
	...
	*/
	CCalculator (LibPrimesHandle pHandle);
public:
...
public:
	...
	*/
	CFactorizationCalculator (LibPrimesHandle pHandle);
public:
	...
	*/
	void GetPrimeFactors (std::vector<sPrimeFactor> & PrimeFactorsBuffer);
};
...
public:
	...
	*/
	CSieveCalculator (LibPrimesHandle pHandle);
public:
...
class CWrapper {
public:
	static void CheckError(CBase * pBaseClass, LibPrimesResult nResult);
	...
	*/
	static bool GetLastError (CBase * pInstance, std::string & sErrorMessage);

	/**
	* CWrapper::ReleaseInstance - Releases the memory of an Instance
	* @param[in] pInstance - Instance Handle
	*/
	static void ReleaseInstance (CBase * pInstance);
	...
	*/
	static PFactorizationCalculator CreateFactorizationCalculator ();

	/**
	* CWrapper::CreateSieveCalculator - Creates a new SieveCalculator instance
	* @return New SieveCalculator instance
	*/
	static PSieveCalculator CreateSieveCalculator ();

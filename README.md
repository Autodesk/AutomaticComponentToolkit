...
| Binding         |         Status                                             | Operating Systems | Linking Type |   class   |  scalar type  |     struct    |  enumeration  |     string    | basicarray | structarray | Callbacks | Error Message Propagation | Injection | API Documentation |
|:---------------:|:----------------------------------------------------------:|:-----------------:|:------------:|:---------:|:-------------:|:-------------:|:-------------:|:-------------:|:----------:|:-----------:|:---------:|:---------:|:---------:|:---------:|
| C++             | ![](Documentation/images/Tick.png) mature                  | Win, Linux, MacOS | Static      | in,return | in,out,return | in,out,return | in,out,return | in,out,return |   in,out   |    in,out   |    in     |         +        | + | + |
| C++ Dynamic     | ![](Documentation/images/Tick.png) mature                  | Win, Linux, MacOS | Dynamic      | in,return | in,out,return | in,out,return | in,out,return | in,out,return |   in,out   |    in,out   |    in     |         +        | + | + |
| C               | ![](Documentation/images/Tick.png) mature                  | Win, Linux, MacOS | Static      | in,return | in,out,return | in,out,return | in,out,return | in,out,return |   in,out   |    in,out   |    in     |         +        | - | - |
| C Dynamic       | ![](Documentation/images/Tick.png) mature                  | Win, Linux, MacOS | Dynamic      | in,return | in,out,return | in,out,return | in,out,return | in,out,return |   in,out   |    in,out   |    in     |         +        | - | - |
| Pascal          | ![](Documentation/images/Tick.png) mature                  | Win, Linux, MacOS | Dynamic      | in,return | in,out,return | in,out,return | in,out,return | in,out,return |   in,out   |    in,out   |    in     |         +        | + | + |
| Python3         | ![](Documentation/images/Tick.png) complete (but not very pythonic) | Win, Linux, MacOS | Dynamic      | in,return | in,out,return | in,out,return | in,out,return | in,out,return |   in,out   |    in,out   |    in     |         +        | + | - |
| Golang          | ![](Documentation/images/Tick.png) mature                  | Win, Linux, MacOS | Dynamic      | in,return | in,out,return | in,out,return | in,out,return | in,out,return |   in,out   |    in,out   |    in     |         +        | + | - |
| NodeJS          | ![](Documentation/images/O.png) partial support            | Win, Linux, MacOS | Dynamic      | in,return | in,out,return | in,out,return | in,out,return |     ?        |      ?      |     -     |         +        | - | - |
| C#              | ![](Documentation/images/O.png) experimental               | Win, Linux, MacOS | Dynamic      | in,return | in,out,return | in,out,return | in,out,return |      -       |      -      |     -     |         +        | - | - |
| Java            | ![](Documentation/images/Tick.png) experimental            | Win, Linux, MacOS | Dynamic      | in,return | in,out,return | in,out,return | in,out,return |    in,out    |    in,out   |    in     |         +        | + | - |
| PHP             | ![](Documentation/images/X.png) not implemented            | Win, Linux, MacOS | Dynamic      | -         | -             |       -       |       -       |      -       |       -    |      -      |     -     |         -        | - | - |
